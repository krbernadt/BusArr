...
$query       = mysqli_query($connection, "select * from adminbus where id_admin='$id_admin'");
...
<html lang="en">
  <head>
    ...
    <title>Bus-Arr | Data Admin </title>
          ...
          <form method="post" action="update-admin.php">
            <input type="hidden" value="<?php echo $data['id_admin'];?>" name="id_admin">
              <div class="form-group">
                <label>Nama</label>
                  <input type="text" name="aname" class="form-control" id="name"  value="<?php echo $data['aname'];?>">
              </div>
              <div class="form-group">
                <label>Email</label>
