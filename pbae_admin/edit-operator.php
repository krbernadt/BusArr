...
include 'koneksi.php';
$id_op   = $_GET['id_op'];
$query       = mysqli_query($connection, "select * from operator where id_op='$id_op'");
    ...
    <div class="wrapper">
      ...
      <div class="table-responsive">
        ...
        <div class="table-title">
          <div class="row">
            <div class="col-sm-12">
              <h2>Edit Data <b>Operator</b></h2>
              <hr />
            </div>
          <br>
          <div class="col-md-12">
          <div class="table table-striped table-hover">
          <form method="post" action="update-operator.php">
            <input type="hidden" value="<?php echo $data['id_op'];?>" name="id_op">
              <div class="form-group">
                <label>Nama</label>
                  <input type="text" name="oname" class="form-control" id="oname"  value="<?php echo $data['oname'];?>">
              </div>
              <div class="form-group">
                <label>Email</label>
              ...
              <div class="form-group">
                <label>Password</label>
                  <input type="text" name="psswd" class="form-control" id="password"  value="<?php echo $data['psswd'];?>">
              </div>
              <div>
              <div class="form-group">
                <label>No Telp</label>
                  <input type="text" name="no_tlp" class="form-control" id="no_tlp"  value="<?php echo $data['no_tlp'];?>">
              </div>
              <div>
