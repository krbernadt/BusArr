          ...
          <div class="table-responsive">
            <div class="table-wrapper">
              ...
              <tbody>
                <?php
                  include 'koneksi.php';
                    $query = mysqli_query($connection, "SELECT * FROM monitoring");
                    $no = 1;
                ...
                <tr>
                  ...
                  <td>
                    <a href="edit-monitoring.php?id_monitor=<?php echo $data['id_monitor'];?>">
                      <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                    </a>
                    <a href="delete-monitoring.php?id_monitor=<?php echo $data['id_monitor'];?>">
