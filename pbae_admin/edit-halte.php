...
$query       = mysqli_query($connection, "select * from halte where id_halte='$id_halte'");
...
<html lang="en">
  <head>
    ...
    <title>Bus-Arr | Data Halte </title>
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="data-halte.php" class="nav-link active">
      ...
      <div class="table-responsive">
        ...
        <div class="table-title">
          <div class="row">
            <div class="col-sm-12">
              <h2>Edit Data <b>Halte</b></h2>
              <hr />
            </div>
          <br>
          <div class="col-md-12">
          <div class="table table-striped table-hover">
          <form method="post" action="update-halte.php">
            <input type="hidden" value="<?php echo $data['id_halte'];?>" name="id_halte">
              <div class="form-group">
                <label>Nama Halte</label>
                  <input type="text" name="halte" class="form-control" id="halte"  value="<?php echo $data['halte'];?>">
              </div>
              <div class="form-group">
                <label>Code Corridor</label>
                  <input type="text" name="code_corridor" class="form-control" id="code_corridor"  value="<?php echo $data['code_corridor'];?>">
              </div>
              <div class="form-group">
                <label>Longitude</label>
                  <input type="text" name="lng" class="form-control" id="lng"  value="<?php echo $data['lng'];?>">
              </div>
              <div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Picture</label>
                  <input type="text" name="pict" class="form-control" id="pict"  value="<?php echo $data['pict'];?>">
              </div>
              <div>
