    ...
    <div class="wrapper">
      ...
      <div class="table-responsive">
        ...
        <div class="table-title">
          <div class="row">
            <div class="col-sm-12">
              <h2>Add <b>Operator</b></h2>
              <hr />
            </div>
          <br>
          <div class="col-md-12">
          <div class="table table-striped table-hover">
          <form action="save-operator.php" method="post">
              <div class="form-group">
                <label>Nama</label>
                  <input type="text" name="oname" class="form-control" id="aname" placeholder="Nama">
              </div>
              <div class="form-group">
                <label>Email</label>
              ...
              <div>
              <button type="submit" name="add-operator" id="submit" class="btn btn-outline-secondary">Add Operator</button>
              </div>
          </form>
      </div>
      </div>
