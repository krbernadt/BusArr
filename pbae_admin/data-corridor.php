                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Daftar <b>Corridor</b></h2>
                                </div>
                                <div class="col-sm-6" style="text-align: end;">
                                  <a href="add-corridor.php" class="btn btn-success">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <?php
                              ...
                              $query = mysqli_query($connection, "SELECT * FROM corridor");
                              $no = 1;
                            ...
                            ?>
                              <tr>
                                ...
                                <td><?php echo $no++;?></td>
                                <td><?php echo $data['code_corridor'];?></td>
                                <td><?php echo $data['rute'];?></td>

                  
                                <td><a href="edit-corridor.php?id_corridor=<?php echo $data['id_corridor'];?>">
                                <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                </a>
                                  <a href="delete-corridor.php?id_corridor=<?php echo $data['id_corridor'];?>">
