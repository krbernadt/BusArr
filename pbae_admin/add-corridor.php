    ...
    <div class="wrapper">
      ...
      <div class="table-responsive">
        ...
        <div class="table-title">
          <div class="row">
            <div class="col-sm-12">
              <h2>Add <b>Corridor</b></h2>
              <hr />
            </div>
          <br>
          <div class="col-md-12">
          <div class="table table-striped table-hover">
          <form action="save-corridor.php" method="post">
              ...
              <div class="form-group">
                <label>Rute</label>
                  <input type="text" name="rute" class="form-control" id="rute" placeholder="Rute">
              </div>
              
              <button type="submit" name="add-corridor" id="submit" class="btn btn-outline-secondary">Add Corridor</button>
              </div>
          </form>
      </div>
      </div>
