    ...
    <div class="wrapper">
      ...
      <div class="table-responsive">
        ...
        <div class="table-title">
          ...
          <form action="save-halte.php" method="post">
              <div class="form-group">
                <label>Nama Halte</label>
                  <input type="text" name="halte" class="form-control" id="halte" placeholder="Nama Halte">
              </div>
              <div class="form-group">
                <label>Code Corridor</label>
                  <input type="text" name="code_corridor" class="form-control" id="code_corridor" placeholder="Code Corridor">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Picture</label>
                  <input type="text" name="pict" class="form-control" id="pict" placeholder="Picture">
              </div>
              <div>
              <button type="submit" name="add-halte" id="submit" class="btn btn-outline-secondary">Add Halte</button>
              </div>
          </form>
      </div>
      </div>
