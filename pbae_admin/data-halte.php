                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>Daftar <b>Halte</b></h2>
                                </div>
                                <div class="col-sm-6" style="text-align: end;">
                                <a href="add-halte.php" class="btn btn-success">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <?php
                              ...
                              $query = mysqli_query($connection, "SELECT * FROM halte");
                              $no = 1;
                              while ($data = mysqli_fetch_assoc($query)) {
                            ?>
                              <tr>
                                <td><?php echo $no++;?></td>
                                <td><?php echo $data['halte'];?></td>
                                ...
                                <td>
                                <a href="edit-halte.php?id_halte=<?php echo $data['id_halte'];?>">
                                <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                </a>
                                  <a href="delete-halte.php?id_halte=<?php echo $data['id_halte'];?>">
